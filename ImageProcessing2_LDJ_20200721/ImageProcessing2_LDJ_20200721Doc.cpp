...
ON_COMMAND(ID_END_IN_SEARCH, &CImageProcessing2LDJ20200721Doc::OnEndInSearch)
ON_COMMAND(ID_HISTOGRAM, &CImageProcessing2LDJ20200721Doc::OnHistogram)
ON_COMMAND(ID_HISTO_EQUAL, &CImageProcessing2LDJ20200721Doc::OnHistoEqual)
ON_COMMAND(ID_HISTO_SPEC, &CImageProcessing2LDJ20200721Doc::OnHistoSpec)
ON_COMMAND(ID_EMBOSSING, &CImageProcessing2LDJ20200721Doc::OnEmbossing)
ON_COMMAND(ID_BLURR, &CImageProcessing2LDJ20200721Doc::OnBlurr)
ON_COMMAND(ID_GAUSSIAN_FILTER, &CImageProcessing2LDJ20200721Doc::OnGaussianFilter)
ON_COMMAND(ID_HPF_SHARPENING, &CImageProcessing2LDJ20200721Doc::OnHpfSharpening)
ON_COMMAND(ID_SHARPENING, &CImageProcessing2LDJ20200721Doc::OnSharpening)
ON_COMMAND(ID_LPFSHARPENING, &CImageProcessing2LDJ20200721Doc::OnLpfsharpening)
ON_COMMAND(ID_DIFF_OPERATOR_HOR, &CImageProcessing2LDJ20200721Doc::OnDiffOperatorHor)
ON_COMMAND(ID_HOMOGEN_OPERATOR, &CImageProcessing2LDJ20200721Doc::OnHomogenOperator)
ON_COMMAND(ID_LAPLACIAN, &CImageProcessing2LDJ20200721Doc::OnLaplacian)
ON_COMMAND(ID_NEAREST, &CImageProcessing2LDJ20200721Doc::OnNearest)
ON_COMMAND(ID_BILINEAR, &CImageProcessing2LDJ20200721Doc::OnBilinear)
ON_COMMAND(ID_MEDIANSUB, &CImageProcessing2LDJ20200721Doc::OnMediansub)
ON_COMMAND(ID_MEANSUB, &CImageProcessing2LDJ20200721Doc::OnMeansub)
ON_COMMAND(ID_TRANSLATION, &CImageProcessing2LDJ20200721Doc::OnTranslation)
ON_COMMAND(ID_MIRRORHOR, &CImageProcessing2LDJ20200721Doc::OnMirrorhor)
ON_COMMAND(ID_MIRRORVER, &CImageProcessing2LDJ20200721Doc::OnMirrorver)
ON_COMMAND(ID_ROTATION, &CImageProcessing2LDJ20200721Doc::OnRotation)
ON_COMMAND(ID_MASK, &CImageProcessing2LDJ20200721Doc::OnMask)
END_MESSAGE_MAP()
...
void CImageProcessing2LDJ20200721Doc::OnEndInSearch()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i;
	unsigned char LOW, HIGH, MAX, MIN;
...
void CImageProcessing2LDJ20200721Doc::OnHistogram()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	// 히스토그램의 값은 0~255
...
void CImageProcessing2LDJ20200721Doc::OnHistoEqual()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, value;
...
void CImageProcessing2LDJ20200721Doc::OnHistoSpec()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProcessing2LDJ20200721Doc::OnEmbossing()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
double** CImageProcessing2LDJ20200721Doc::OnMaskProcess(unsigned char* Target, double Mask[3][3])
{
	// TODO: 여기에 구현 코드 추가.
	// 회선 처리가 일어나는 함수
	int i, j, n, m;
...
double** CImageProcessing2LDJ20200721Doc::OnScale(double** Target, int height, int width)
{
	// TODO: 여기에 구현 코드 추가.
	// 정규화를 위한 함수
	int i, j;
...
double** CImageProcessing2LDJ20200721Doc::Image2DMem(int height, int width)
{
	// TODO: 여기에 구현 코드 추가.
	// 2차원 메모리 할당을 위한 함수
	double** temp;
...
void CImageProcessing2LDJ20200721Doc::OnBlurr()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CImageProcessing2LDJ20200721Doc::OnGaussianFilter()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CImageProcessing2LDJ20200721Doc::OnSharpening()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CImageProcessing2LDJ20200721Doc::OnHpfSharpening()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CImageProcessing2LDJ20200721Doc::OnLpfsharpening()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CConstDlg dlg; // 상수를 입력받으려고 대화상자 선언
	int i, j, alpha;
...
void CImageProcessing2LDJ20200721Doc::OnDiffOperatorHor()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CImageProcessing2LDJ20200721Doc::OnHomogenOperator()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j, n, m;
...
double CImageProcessing2LDJ20200721Doc::DoubleABS(double X)
{
	// 실수의 절대 값 연산 함수
	if (X >= 0)
		return X;
...
void CImageProcessing2LDJ20200721Doc::OnLaplacian()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CImageProcessing2LDJ20200721Doc::OnNearest()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CImageProcessing2LDJ20200721Doc::OnBilinear()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProcessing2LDJ20200721Doc::OnMediansub()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProcessing2LDJ20200721Doc::OnBubleSort(double* A, int MAX)
{
	// TODO: 여기에 구현 코드 추가.
	// 데이터의 정렬을 처리하는 함수
	int i, j;
...
void CImageProcessing2LDJ20200721Doc::OnSwap(double* a, double* b)
{
	// TODO: 여기에 구현 코드 추가.
	// 데이터 교환 함수
	double temp;
...
void CImageProcessing2LDJ20200721Doc::OnMeansub()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProcessing2LDJ20200721Doc::OnTranslation()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CImageProcessing2LDJ20200721Doc::OnMirrorhor()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
	m_Re_height = m_height;
...
void CImageProcessing2LDJ20200721Doc::OnMirrorver()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
	m_Re_height = m_height;
...
void CImageProcessing2LDJ20200721Doc::OnRotation()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
